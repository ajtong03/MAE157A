...
def desired_rotation_matrix(Td, ad):
...
c_y = solve_polynomial_coefficients(tf, -1.5 , 0 ,0, 0, 0, 1.4142,-4.33, 0 )
print("y-coeffs:", c_y)
def y_t(t):
...
# Departure Segment 
# Initial Boundary Conditions must must final BCs from approach segment
tf1 =  8# seconds
...
# y - dir
c_y1 = solve_polynomial_coefficients(tf1, 0 , 1.4142 ,0, 0, 1.5, 0, 0, 0 )
print("y-coeffs:", c_y1)
def y_t1(t):
...
plt.plot(time_approach, [vx_t(t) for t in time_approach], label="Velocity")
